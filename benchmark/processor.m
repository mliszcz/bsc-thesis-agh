...
(*outPath="/home/michal/Documents/inz/results_t440_dry/out_t2/";*)
(**)
(*s4K=4*1024;*)
(*s512K=512*1024;*)
(*s1M=2*s512K;*)
...
(**)
(*PlotLabel->plotLabel,*)
(*LabelStyle->{FontColor->Black,FontFamily->"Helvetica",FontSize->14},*)
(**)
(*Filling->Axis,*)
(*FrameLabel->axesLabel,*)
(*Frame->True,*)
(*AxesOrigin->{1,0},*)
(*AxesStyle->{FontFamily->"Helvetica",FontSize->14},*)
...
(*];*)
(**)
(*shadowbox[legend_]:=Graphics[{{Gray,Rectangle[{0.05,-0.55},{1.05,1.55}]},{White,EdgeForm[Gray],Rectangle[{0.05,-0.55},{1.05,1.55}]},Inset[legend,{0.5,0.5},Center]},ImageSize->60];*)
